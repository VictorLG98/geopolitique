          ...
          <form onSubmit={handleCommentSubmit} className="glass-panel p-6 rounded-xl space-y-4 shadow-sm">
            ...
            <div className="flex items-center justify-between pt-2">
              ...
              {submitStatus === 'success' && (
                <span role="status" className="text-xs text-emerald-700 font-semibold flex items-center gap-1 animate-fade-in">
              ...
              {submitStatus === 'error' && (
                <span role="alert" className="text-xs text-rose-700 font-semibold flex items-center gap-1 animate-fade-in">
