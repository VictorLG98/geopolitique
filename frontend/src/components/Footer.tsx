      ...
      <div className="mx-auto max-w-6xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="glass-panel p-8 md:p-12 rounded-2xl flex flex-col md:flex-row items-center justify-between gap-8 animate-fade-in">
          ...
          <div className="w-full max-w-md">
            ...
            {status === 'success' && (
              <p role="status" className="mt-3 text-xs text-emerald-700 font-semibold flex items-center gap-1.5 animate-fade-in">
                <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-emerald-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
            ...
            {status === 'error' && (
              <p role="alert" className="mt-3 text-xs text-rose-700 font-semibold flex items-center gap-1.5 animate-fade-in">
                <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-rose-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
